const TippsComponent = () => {
  const classes = [`lg:w-[45%]  bg-gradient-to-r
          from-red-500/20 to-amber-500/20 p-6 rounded-2xl flex flex-col gap-4 justify-between`,
  ...
  return <>
    ...
    <div className="w-full ah-64 bg-gray-900 text-white  my-12 rounded-3xl p-6">
