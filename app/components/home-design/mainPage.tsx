  ...
  return <>
    <div className="main bg-[#FFFEF5] lg:py-40 lg:pl-2 max-lg:pb-12 max-lg:pt-12 max-lg:p-4 flex max-lg:flex-col 
      ...
      <div className="main_content max-lg:flex flex-col gap-8 lg:w-[45%]">
        ...
        <div className="results text-black flex justify-between w-[85%] flex-wrap gap-12 max-lg:p-4">
          <div className="erfolg flex flex-col items-start">
            <span className="lg:text-3xl max-lg:text-2xl text-red-600">95%</span>
            <span className="text-lg text-gray-600">Erfolgsquote</span>
          </div>
          <div className="erfolg flex flex-col items-start">
            <span className="lg:text-3xl max-lg:text-2xl text-yellow-700">A1-C1</span>
            <span className="text-lg text-gray-600">Alle Niveaus</span>
          </div>
          <div className="erfolg flex flex-col items-start">
            <span className="lg:text-3xl max-lg:text-2xl text-black">4Skills</span>
